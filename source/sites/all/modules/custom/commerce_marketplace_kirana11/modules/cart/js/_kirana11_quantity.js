(function ($) {
  ...
  Drupal.behaviors.my_view_machine_name = {
    attach: function(context, settings) {
      ...
      // Rest the form action to '/cart' (after view refresh the form action resets to '/').
      $('#edit-checkout').once().click(function() {
        $('#views-form-commerce-cart-form-default').attr('action', '/cart');
      });
    }
  }
  ...
  if (typeof Drupal.ajax.prototype != 'undefined' && typeof Drupal.ajax.prototype.commands != undefined) {
